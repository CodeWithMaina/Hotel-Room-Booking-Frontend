            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
                ...
                <div className="space-y-3">
                  ...
                  <button onClick={()=> navigate(`/hotel/rooms/${hotel.hotelId}`)} className="w-full border border-gray-300 text-gray-700 py-3 px-4 rounded-xl hover:bg-gray-50 transition-colors font-medium">
                    Check Availability
                  </button>
                </div>
              </div>
